...
import { API_ROUTE, LoginDto, LoginResponseDto, ApiResponse, AdminProfile, payloadMaker } from '../api'
...
export function useAuthMutation() {
  ...
  return useMutation({
    mutationFn: async (credentials: LoginDto) => {
      ...
      const { data: profileData } = await profileResponse.json() as ApiResponse<AdminProfile>
