export default function TermsOfServicePage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
      <h1 className="text-2xl font-bold text-white mb-6">서비스 이용약관</h1>
      
      <div className="prose prose-invert max-w-none space-y-6">
        <section>
          <h2 className="text-xl font-semibold text-white">제 1 조 (목적)</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white">제 2 조 (용어의 정의)</h2>
          <p className="text-gray-300">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white">제 3 조 (약관의 효력)</h2>
          <p className="text-gray-300">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white">제 4 조 (면책조항)</h2>
          <p className="text-gray-300">
